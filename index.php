...
<head>
	...
	<body>
	<!--Navbar -->
    <!--class ="..." mempengaruhi posisi menu di navbar -->
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                <img class="d-block w-100" src="apple.png" alt="Second slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="starbuck.png" alt="Third slide">
            </div>
        </div>
